...
<p align="center">
<img src="https://raw.githubusercontent.com/sepahead/sepahead/main/assets/agents.svg" width="820" alt="Agentic stack manifest: the agents and environment I build with: herdr (multiplexer), Ghostty (terminal), OMP (orchestrator, oh my opencode), Zed (editor). The loop never sleeps." loading="lazy"/>
</p>
