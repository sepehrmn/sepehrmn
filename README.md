...
<p align="center">
<img src="https://raw.githubusercontent.com/sepahead/sepahead/main/assets/agents.svg" width="820" alt="Agentic stack manifest: the agents and environment I build with: Pi (lead, mono the agent), Claude Code (engineer), Codex (generalist), Zed (editor), Orca (orchestrator), herdr (multiplexer), Ghostty (terminal). The loop never sleeps." loading="lazy"/>
</p>
