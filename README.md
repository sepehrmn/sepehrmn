...
<p align="center">
<img src="https://raw.githubusercontent.com/sepahead/sepahead/main/assets/agents.svg" width="820" alt="Agentic stack manifest: the agents and environment I build with: Ghostty (terminal), herdr (multiplexer), Devin (autonomous), OMP (orchestrator, oh my opencode), Pi (lead). The loop never sleeps." loading="lazy"/>
</p>
