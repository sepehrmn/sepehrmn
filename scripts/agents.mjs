...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${W} ${H}" width="${W}" height="${H}" role="img" aria-label="Agentic stack manifest: the agents and environment I build with. Pi (lead, mono the agent); Claude Code (engineer); Codex (generalist); Zed (editor); Orca (orchestrator, multi-agent); herdr (multiplexer, agent herd in the terminal); Ghostty (terminal). The loop never sleeps.">
